# SQS with Polling — Order Processing Use Case
...
| [`AwsConfig.java`](../src/main/java/org/example/config/AwsConfig.java) | Builds `SqsClient` with credentials | `application.properties` |
